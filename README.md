...
<html class="no-js" lang="">
  <head>
    ...
    <title>synQrona | Generative AI enterprise automation platform</title>
  ...
  <body>
            ...
            <div class="col-lg-12">
              <nav class="navbar navbar-expand-lg">
                <a class="navbar-brand" href="index.html">
				  ...
				  <h1 style="color:MediumSeaGreen;">synQrona</h1><p></p>
                </a>
                ...
                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
									<div class="ms-auto">
										<ul id="nav" class="navbar-nav ms-auto">
											...
											<li class="nav-item">
												<a class="page-scroll" href="#features">Product</a>
											</li>
											<li class="nav-item">
    ...
    <section id="home" class="hero-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-xl-6 col-lg-6 col-md-10">
            <div class="hero-content">
							<h2>synQrona platform automates your disparate business processes across enterprise applications</h2>
							<p>No code to write, no infrastructure to setup, just start talking to synQrona to automate tedious tasks in minutes!</p>
							
							<a href="#0" class="main-btn btn-hover">Request Demo</a>
            </div>
					</div>
				...
				<div class="row">
					<div class="col-lg-5 col-md-10">
						<div class="section-title mb-60">
							<h2 class="mb-20">Build enterprise automation apps with generative ai to achieve business outcomes faster</h2>
							<p>synQrona platform builds generative ai apps that live alongside your enterprise applications while automating disparate business processes</p>
						</div>
					</div>
							...
							<div class="col-lg-6 col-md-6">
								<div class="single-feature">
									...
									<div class="feature-content">
										<h4>No Code SaaS</h4>
										<p>You don't have to manage infrastructure or write code.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="single-feature">
									...
									<div class="feature-content">
										<h4>Secure from start</h4>
										<p>data security and privacy is weaved into every aspect of the platform.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="single-feature">
									...
									<div class="feature-content">
										<h4>Agile</h4>
										<p>Tools to build automated processes quickly and adapt to changing business and economy.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="single-feature">
									...
									<div class="feature-content">
										<h4>Innovate</h4>
										<p>We bring in some of the most cutting edge innovations to the platform that you can start leveraging from start.</p>
									</div>
								</div>
							</div>
						</div>
		...
		<!-- ========================= footer start ========================= -->
		<footer id="contact" class="footer pt-120">
			<div class="container">
				<div class="row">
					<div class="col-xl-3 col-lg-4 col-md-6 col-sm-10">
						<div class="footer-widget">
							...
							<p class="desc">Talk to your enterprise apps through synQrona and get your work done in minutes.</p>
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="footer-widget">
							...
							<form action="#">
								...
								<button class="main-btn btn-hover">Request Demo</button>
							</form>
						</div>
					</div>
				</div>
